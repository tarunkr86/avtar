...
<div class="row-fluid" ng-controller="jobTypesController">
	<div class="span8">
		<ul class="breadcrumb">
			<li><a href="#">You are here : Job Types </a> <span
				class="divider">/</span></li>
			<li><a href="#">Manage Job Types</a> <span class="divider">/</span></li>
		</ul>
	</div>
	<div class="span2">
		<h4>
			<!--  <div ng-class="{'text-center': displayCreateJobTypeButton == false, 'none': displayCreateJobTypeButton == false}">
            <br/>-->
			<a href="#addJobTypesModal" role="button" ng-click="resetJobType();"
				title="<spring:message code='create'/>&nbsp;<spring:message code='jobType'/>"
				class="btn btn-inverse" data-toggle="modal"> <i
				class=" icon-plus-sign"></i> &nbsp;&nbsp;<spring:message
					code="create" />&nbsp;<spring:message code="jobType" />
			</a>
			<!--   </div>-->
		</h4>
	</div>
	<div class="span2">
		<h4>
			<a href="#searchJobTypesModal" id="jobTypesHeaderButton"
				role="button"
				ng-class="{'': displaySearchButton == true, 'none': displaySearchButton == false}"
				title="<spring:message code="search"/>&nbsp;<spring:message code="jobType"/>"
				class="btn btn-inverse" data-toggle="modal"> <i
...
<div class="row-fluid" ng-controller="jobTypesController">
	...
	<div>
		<div id="loadingModal" class="modal hide fade in centering"
			role="dialog" aria-labelledby="deleteJobTypesModalLabel"
			aria-hidden="true">
		...
		<div
			ng-class="{'alert badge-inverse': displayMessageToJobType == true, 'none': displayMessageToJobType == false}">
			<h4 class="displayInLine">
				<p class="messageToJobType displayInLine">
		...
		<div
			...
			<h4>
				<i class="icon-info-sign"></i>
				<spring:message code="jobTypes.emptyData" />
			</h4>
			<br />

			<p>
				<spring:message code="jobTypes.emptyData.text" />
			</p>
		</div>
		...
		<div id="gridContainer"
			...
			<table class="table table-bordered table-striped">
				<thead>
					<tr>
						<th scope="col"><spring:message code="jobTypes.name" /></th>
						<th scope="col"><spring:message code="jobTypes.action" /></th>
					</tr>
				</thead>
				<tbody>
					<tr ng-repeat="jobType in page.source" style="height: auto;">

						<td class="tdJobTypesCentered">{{jobType.name}}</td>
						<td class="width15">
							<div class="text-center">
								<input type="hidden" value="{{jobType.id}}" /> <a
									href="#updateJobTypesModal"
									ng-click="selectedJobType(jobType);" role="button"
									title="<spring:message code="update"/>&nbsp;<spring:message code="jobType"/>"
									class="btn btn-inverse" data-toggle="modal"> <i
									class="icon-edit"></i>
								</a> <a href="#deleteJobTypesModal"
									ng-click="selectedJobType(jobType);" role="button"
									title="<spring:message code="delete"/>&nbsp;<spring:message code="jobType"/>"
									class="btn btn-inverse" data-toggle="modal"> <i
									class="icon-minus"></i>
								</a>
							</div>
		...
		<jsp:include page="dialogs/jobTypesDialogs.jsp" />

	</div>
</div>

<script src="<c:url value="/resources/js/pages/jobTypes.js" />"></script>